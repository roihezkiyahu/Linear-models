...
\\
\textrm{the corresponding test statistic } T_j \textrm{ is: } \sqrt{\frac{RSS_{\hat\beta_{MLE}} - RSS_{\hat\beta_0}}{\sigma^2}}
$$
...
$$
T_j^2 <2 \iff C_{p-1} - C_P >0 \iff \ x_j \textrm{ is not significant and may be dropped out of the model (according to the Mallows' Cp criterion)}
\\
